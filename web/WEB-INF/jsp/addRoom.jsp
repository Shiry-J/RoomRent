...
<div class="AddBody">
    <div class="title">添加房屋</div>
    <form method="post" action="${pageContext.request.contextPath}/addRoom" enctype="multipart/form-data">
        <div class="box">
            <div class="box1">标题：</div>
            <div class="box2">
                <input class="box3" type="text" name="title" id="title" placeholder="请输入标题" onblur="checkTitle()" onkeyup="checkTitle()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box3" type="text" name="house_type" id="house_type" placeholder="x室x厅x卫" onblur="checkHouse_type()" onkeyup="checkHouse_type()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box4" type="text" name="area" id="area" placeholder="请输入面积" onblur="checkArea()" onkeyup="checkArea()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box3" type="text" name="region" id="region" placeholder="xx省xx市xx区" onblur="checkRegion()" onkeyup="checkRegion()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box3" type="text" name="community" id="community" placeholder="请输入小区名" onblur="checkCommunity()" onkeyup="checkCommunity()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box4" type="text" name="floor" id="floor" placeholder="请输入楼层" onblur="checkFloor()" onkeyup="checkFloor()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box4" type="text" name="price" id="price" placeholder="请输入租金" onblur="checkPrice()" onkeyup="checkPrice()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box3" type="text" name="content" id="content" placeholder="请输入描述" onblur="checkContent()" onkeyup="checkContent()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box6" type="text" name="contacts" id="contacts" placeholder="请输入联系人" onblur="checkContacts()" onkeyup="checkContacts()">
        ...
        <div class="box">
            ...
            <div class="box2">
                <input class="box7" type="text" name="phone" id="phone" placeholder="请输入联系电话" onblur="checkPhone()" onkeyup="checkPhone()">
...
<script>
    ...
    function checkArea(){
        ...
        if (area.length<1 || area>=1000){
            span.innerHTML = "<font color='red' size='3px'>房屋面积不能为空或存在错误</font>";
            return false;
        }else{
            span.innerHTML = "";
            return true;
